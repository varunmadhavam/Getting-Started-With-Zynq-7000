...
HD_PWD='/home/varun/coding/fpga/xylinx/pynq_z1/mpsoc_only_ps_gpio/mpsoc_only_ps_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_only_ps_gpio_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mpsoc_only_ps_gpio_design_wrapper.tcl -notrace
