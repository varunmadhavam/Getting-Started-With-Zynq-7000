...
//Command     : generate_target mpsoc_only_ps_gpio_design_wrapper.bd
//Design      : mpsoc_only_ps_gpio_design_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module mpsoc_only_ps_gpio_design_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  IOBUF GPIO_0_0_tri_iobuf_3
       (.I(GPIO_0_0_tri_o_3),
        ...
        .O(GPIO_0_0_tri_i_3),
        .T(GPIO_0_0_tri_t_3));
  mpsoc_only_ps_gpio_design mpsoc_only_ps_gpio_design_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
