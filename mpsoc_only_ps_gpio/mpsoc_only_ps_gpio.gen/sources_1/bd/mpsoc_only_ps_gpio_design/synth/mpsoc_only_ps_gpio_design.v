...
//Date        : Fri Jun  4 10:48:45 2021
//Host        : varun-UX430UNR running 64-bit Ubuntu 20.04.2 LTS
//Command     : generate_target mpsoc_only_ps_gpio_design.bd
//Design      : mpsoc_only_ps_gpio_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mpsoc_only_ps_gpio_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mpsoc_only_ps_gpio_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "mpsoc_only_ps_gpio_design.hwdef" *) 
module mpsoc_only_ps_gpio_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  mpsoc_only_ps_gpio_design_processing_system7_0_1 processing_system7_0
